        ...
        <div class="max-w-7xl mx-auto space-y-6">
            @if(session('success'))
                <div x-data="{ show: true }"
                     ...
                     class="relative">
                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 border-l-4 border-green-500 dark:border-green-600 p-4 rounded-lg shadow-lg">
                            ...
                            <div class="ml-auto pl-3">
                                <div class="-mx-1.5 -my-1.5">
                                    <button @click="show = false"
                                            class="inline-flex rounded-md p-1.5 text-green-500 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800 transition-colors">
                    ...
                    <div class="text-center md:text-left w-full">
                        ...
                        <div class="flex justify-center md:justify-start flex-wrap gap-2 mt-2">
                            ...
                            <span class="px-2 py-0.5 bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 text-xs font-medium rounded-full">
                                Menjadi Ahli sejak {{ auth()->user()->created_at->format('F j, Y') }}
                            </span>
                        </div>
