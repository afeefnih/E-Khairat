<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        <!-- Dependent Name -->
        <div class="space-y-2">
            <label for="dependent_full_name"
                class="block font-medium text-gray-700 dark:text-gray-200 transition-colors duration-200">
                Full Name
            </label>
            <input type="text" name="dependent_full_name" id="dependent_full_name" wire:model="dependent_full_name"
        ...
        <!-- Relationship -->
        <div class="space-y-2">
            <label for="dependent_relationship"
                class="block font-medium text-gray-700 dark:text-gray-200 transition-colors duration-200">
                Hubungan
            </label>
            <select name="dependent_relationship" id="dependent_relationship" wire:model="dependent_relationship"
        ...
        <!-- IC Number -->
        <div class="space-y-2">
            <label for="dependent_ic_number"
                class="block font-medium text-gray-700 dark:text-gray-200 transition-colors duration-200">
                No Kad Pengenalan
            </label>
            <input type="text" name="dependent_ic_number" id="dependent_ic_number" wire:model="dependent_ic_number"
                class="w-full px-3 py-2 text-gray-900 bg-white dark:bg-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
        ...
        <!-- Age -->
        <div class="space-y-2">
            <label for="dependent_age"
                class="block font-medium text-gray-700 dark:text-gray-200 transition-colors duration-200">
                Umur
            </label>
            <input type="number" name="dependent_age" id="dependent_age" wire:model="dependent_age"
                class="w-full px-3 py-2 text-gray-900 bg-white dark:bg-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
