...
<div class="mt-6">
    ...
    <div class="flex justify-end">
        <button wire:click="saveDependents" type="submit" class="px-4 py-2 bg-blue-700 text-white rounded-lg shadow-sm hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Simpan dan Teruskan
        </button>
    </div>
</div>
