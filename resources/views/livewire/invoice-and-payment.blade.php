        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                    ...
                    <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">Maklumat Tangungan</h2>
                            </div>

                            <a wire:navigate class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200" href="{{route('register.dependent')}}">Kemaskini Tanguangan</a>
                        </div>
                    </div>
                        ...
                        <table class="w-full">
                            <thead>
                                <tr class="bg-gray-50 dark:bg-gray-700">
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Pertalian</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">No. KP</th>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div class="px-6 py-6">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-blue-600 dark:text-blue-400">RM {{ number_format($baseFee, 2) }}</span>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="text-sm">
                                <label for="terms" class="font-medium text-gray-700 dark:text-gray-300">
                                    {!! __('Saya setuju dengan :Terma dan Syarat ', [
                                        'Terma dan Syarat' => '<a target="_blank" href="'.route('terms.show').'" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">'.__('Terma dan Syarat').'</a>',
                                    ]) !!}
                                </label>
                            </div>
                        </div>
                ...
                <div class="flex justify-end">
                    <button wire:submit.prevent="editDependent" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white text-base font-medium rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900">
                        Teruskan Pembayaran
                    </button>
                </div>

                <a wire:navigate href="{{route('register.dependent')}}"></a>
            </div>
        </div>
    </div>
</x-authentication-card>
